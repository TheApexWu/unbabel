...
export const NEIGHBORHOODS: Neighborhood[] = [
  {
    ...
    zips: ["11372", "11370"],
    adjacent: ["flushing", "bushwick", "astoria", "corona", "elmhurst"],
    borough: "Queens",
  ...
  },
  {
    ...
    name: "Sunset Park",
    zips: ["11220", "11232"],
    adjacent: ["bushwick", "brighton-beach"],
    borough: "Brooklyn",
  ...
  },
  {
    ...
    name: "Bushwick",
    zips: ["11221", "11237"],
    adjacent: ["sunset-park", "east-harlem"],
    borough: "Brooklyn",
  ...
  },
  {
    ...
    name: "Corona",
    zips: ["11368"],
    adjacent: ["jackson-heights", "flushing", "elmhurst"],
    borough: "Queens",
  ...
  },
  {
    ...
    name: "East Harlem",
    zips: ["10029", "10035"],
    adjacent: ["washington-heights", "chinatown", "fordham"],
    borough: "Manhattan",
  ...
  },
  {
    ...
    adjacent: ["jackson-heights", "corona"],
    borough: "Queens",
    description: "More languages per square mile than anywhere on Earth.",
    image: "",
  },
  {
    slug: "chinatown",
    name: "Chinatown",
    zips: ["10002", "10013"],
    adjacent: ["east-harlem"],
    borough: "Manhattan",
    description: "The oldest landing pad in the city.",
    image: "",
  },
  {
    slug: "brighton-beach",
    ...
    borough: "Brooklyn",
    description: "Little Odessa by the sea.",
    image: "",
  },
  {
    slug: "fordham",
    name: "Fordham",
    zips: ["10458"],
    adjacent: ["east-harlem", "washington-heights"],
    borough: "Bronx",
    description: "The Grand Concourse hums in Albanian and Spanish.",
    image: "",
  },
];
